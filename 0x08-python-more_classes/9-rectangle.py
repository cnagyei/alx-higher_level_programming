...
class Rectangle:
    ...
    def __str__(self):
        ...
        for i in range(self.__height):
            [area.append(str(self.print_symbol)) for j in range(self.__width)]
    ...
    def square(cls, size=0):
        """Returns new rectangle instance as a square.

        Args:
            @size: New size applied to width and height.

        Return:
            New rectangle as a square.
        """
